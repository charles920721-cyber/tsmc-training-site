const I18N_UI = {
  zh: {
    ...
    "about.h1": "認識台積電",
    "about.lead": "公司基本資料、常用關鍵字、職稱職等、加班獎金、內轉制度與 MAE 實務整理。",
  ...
  en: {
    ...
    "about.h1": "About TSMC",
    "about.lead": "Company basics, workplace glossary, job grades, overtime & bonuses, internal transfers, and MAE field notes.",
